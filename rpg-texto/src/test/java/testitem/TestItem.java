...
public class TestItem {
    public static void main(String[] args) {
        ...
        Item pocaoBuffArmadura = new Item("Pocao de debuff de armadura", TipoEfeito.BUFF_DEFESA, 1);
        Item pocaoBuffAtaque = new Item("Poca de buff em ataque", TipoEfeito.BUFF_ATAQUE, 1);
        
        System.out.println(pocaoCura);
        System.out.println(pocaoDano);
        System.out.println(pocaoBuffArmadura);
